...
public class SmoothFollow : MonoBehaviour {
    ...
    public Transform target; // The distance in the x-z plane to the target 
    public float distance = 10.0f; // the height we want the camera to be above the target
    public float height = 5.0f; // How much we 
    ...
    void LateUpdate( ) { // Early out if we don't have a target if (!target) return;
        ...
        Quaternion currentRotation = (Quaternion) Quaternion.Euler(0, currentRotationAngle, 0);
